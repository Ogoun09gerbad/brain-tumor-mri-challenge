...
This baseline achieves ~92% accuracy and ~0.91 F1 Score (weighted).
"""
...
def train():
    ...
    print(f"[INFO] Class mapping: {train_ds.class_to_idx}")
...
def predict():
    ...
    # Load test dataset (preserving filenames)
    test_transform = get_transforms(train=False)

    # We need filenames — use a custom approach
    ...
    print("\nNext: Encrypt and submit!")
    print(f"  python encryption/encrypt.py {PRED_CSV} encryption/public_key.pem submissions/baseline.enc")
